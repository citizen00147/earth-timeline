...
function init() {
  ...
  loader.load("space_rocks_model-v1.glb", function (gltf) {
    gltf.scene.scale.set(1, 1, 1);
    let rocks = gltf.scene;
    scene.add(rocks);
  ...
  const canvas = document.getElementById("displayRocks");
...
export * as rockAnimation from "/components/rock-animation.js";
