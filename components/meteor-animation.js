...
function init() {
  ...
  loader.load("meteor_model-v1.glb", function (gltf) {
    gltf.scene.scale.set(0.5, 0.5, 0.5);
    let meteor = gltf.scene;
    scene.add(meteor);
  ...
  const canvas = document.getElementById("displayMeteor");
...
export * as meteorAnimation from "/components/meteor-animation.js";
